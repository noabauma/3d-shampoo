...
def main():
    ...
    """
    #optimizer = shampoo_3d.Shampoo_3D(params=model.parameters(), topology=model.topology(), shapes=[tuple(p.shape) for p in model.parameters() if p.requires_grad] ,lr=1e-1, momentum=0.9, hyperparams=shampoo.ShampooHyperParams())
